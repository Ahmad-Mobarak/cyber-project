...
# Try to import Crypto, with fallback to pycryptodome if needed
try:
    from Crypto.Cipher import DES3
except ImportError:
    try:
        # Try alternate import path that some installations use
        from Cryptodome.Cipher import DES3
    except ImportError:
        print("Error: Could not import Crypto or Cryptodome module.")
        print("Please install pycryptodome: pip install pycryptodome")
        print("If the issue persists, try: pip uninstall -y pycrypto && pip uninstall -y pycryptodome && pip install pycryptodome")
        sys.exit(1)
